...
export enum StudentExportColumn {
...
export function studentExportColumnFromJSON(object: any): StudentExportColumn {
  switch (object) {
    case 0:
...
export function studentExportColumnToJSON(object: StudentExportColumn): string {
  switch (object) {
...
export function studentExportColumnToNumber(object: StudentExportColumn): number {
  switch (object) {
    case StudentExportColumn.STUDENT_EXPORT_COLUMN_UNSPECIFIED:
      return 0;
    case StudentExportColumn.STUDENT_EXPORT_COLUMN_ID_NUMBER:
...
function createBaseStudentExportColumnDefinition(): StudentExportColumnDefinition {
  return { column: undefined, label: undefined };
}

export const StudentExportColumnDefinition: MessageFns<StudentExportColumnDefinition> = {
  encode(message: StudentExportColumnDefinition, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StudentExportColumnDefinition {
  ...
  fromJSON(object: any): StudentExportColumnDefinition {
    return {
  ...
  toJSON(message: StudentExportColumnDefinition): unknown {
    const obj: any = {};
    if (message.column !== undefined) {
  ...
  create<I extends Exact<DeepPartial<StudentExportColumnDefinition>, I>>(base?: I): StudentExportColumnDefinition {
    return StudentExportColumnDefinition.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentExportColumnDefinition>, I>>(
    object: I,
...
function createBaseStudentExportSelection(): StudentExportSelection {
  return { school_year_id: undefined, statuses: [], columns: [] };
}

export const StudentExportSelection: MessageFns<StudentExportSelection> = {
  encode(message: StudentExportSelection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.school_year_id !== undefined) {
      ObjectId.encode(message.school_year_id, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StudentExportSelection {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): StudentExportSelection {
    return {
      ...
      columns: globalThis.Array.isArray(object?.columns)
        ? object.columns.map((e: any) => studentExportColumnFromJSON(e))
        : [],
    };
  },

  toJSON(message: StudentExportSelection): unknown {
    const obj: any = {};
    if (message.school_year_id !== undefined) {
  ...
  create<I extends Exact<DeepPartial<StudentExportSelection>, I>>(base?: I): StudentExportSelection {
    return StudentExportSelection.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentExportSelection>, I>>(object: I): StudentExportSelection {
    const message = createBaseStudentExportSelection();
...
function createBaseStudentExportRow(): StudentExportRow {
  return {
    id_number: undefined,
...
export const StudentExportRow: MessageFns<StudentExportRow> = {
  encode(message: StudentExportRow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): StudentExportRow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): StudentExportRow {
    return {
  ...
  toJSON(message: StudentExportRow): unknown {
    const obj: any = {};
    if (message.id_number !== undefined) {
  ...
  create<I extends Exact<DeepPartial<StudentExportRow>, I>>(base?: I): StudentExportRow {
    return StudentExportRow.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentExportRow>, I>>(object: I): StudentExportRow {
    const message = createBaseStudentExportRow();
