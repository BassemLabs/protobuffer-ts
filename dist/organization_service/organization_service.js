...
exports.startSchoolYearPhaseStatusFromJSON = startSchoolYearPhaseStatusFromJSON;
exports.startSchoolYearPhaseStatusToJSON = startSchoolYearPhaseStatusToJSON;
exports.startSchoolYearPhaseStatusToNumber = startSchoolYearPhaseStatusToNumber;
/* eslint-disable */
...
var StartSchoolYearPhase;
(function (StartSchoolYearPhase) {
...
function startSchoolYearPhaseToJSON(object) {
    switch (object) {
...
function startSchoolYearPhaseToNumber(object) {
    switch (object) {
        case StartSchoolYearPhase.START_SCHOOL_YEAR_PHASE_ACTIVATE_ACCOUNTS:
            return 0;
        case StartSchoolYearPhase.START_SCHOOL_YEAR_PHASE_SWITCH_ACTIVE_SCHOOL_YEAR:
...
var StartSchoolYearPhaseStatus;
(function (StartSchoolYearPhaseStatus) {
    StartSchoolYearPhaseStatus["START_SCHOOL_YEAR_PHASE_STATUS_PENDING"] = "START_SCHOOL_YEAR_PHASE_STATUS_PENDING";
    StartSchoolYearPhaseStatus["START_SCHOOL_YEAR_PHASE_STATUS_RUNNING"] = "START_SCHOOL_YEAR_PHASE_STATUS_RUNNING";
    StartSchoolYearPhaseStatus["START_SCHOOL_YEAR_PHASE_STATUS_FAILED"] = "START_SCHOOL_YEAR_PHASE_STATUS_FAILED";
    StartSchoolYearPhaseStatus["START_SCHOOL_YEAR_PHASE_STATUS_SUCCEEDED"] = "START_SCHOOL_YEAR_PHASE_STATUS_SUCCEEDED";
    StartSchoolYearPhaseStatus["UNRECOGNIZED"] = "UNRECOGNIZED";
})(StartSchoolYearPhaseStatus || (exports.StartSchoolYearPhaseStatus = StartSchoolYearPhaseStatus = {}));
function startSchoolYearPhaseStatusFromJSON(object) {
    switch (object) {
        case 0:
...
function startSchoolYearPhaseStatusToJSON(object) {
    switch (object) {
...
function startSchoolYearPhaseStatusToNumber(object) {
    switch (object) {
        case StartSchoolYearPhaseStatus.START_SCHOOL_YEAR_PHASE_STATUS_PENDING:
            return 0;
        case StartSchoolYearPhaseStatus.START_SCHOOL_YEAR_PHASE_STATUS_RUNNING:
...
function createBaseStartSchoolYearRun() {
    return {
        id: undefined,
        organization_id: undefined,
        active_school_year_id: undefined,
...
exports.StartSchoolYearRun = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.target_school_year_id !== undefined) {
            object_id_1.ObjectId.encode(message.target_school_year_id, writer.uint32(34).fork()).join();
        }
        if (message.requested_by !== undefined) {
            object_id_1.ObjectId.encode(message.requested_by, writer.uint32(42).fork()).join();
        }
    ...
    create(base) {
        return exports.StartSchoolYearRun.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStartSchoolYearRun();
        message.id = (object.id !== undefined && object.id !== null) ? object_id_1.ObjectId.fromPartial(object.id) : undefined;
...
function createBaseGetCurrentStartSchoolYearRunRequest() {
    return { context: undefined, organization_id: undefined };
}
exports.GetCurrentStartSchoolYearRunRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.context !== undefined) {
            request_context_1.RequestContext.encode(message.context, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.GetCurrentStartSchoolYearRunRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetCurrentStartSchoolYearRunRequest();
        message.context = (object.context !== undefined && object.context !== null)
...
function createBaseGetCurrentStartSchoolYearRunResponse() {
    return { run: undefined };
}
exports.GetCurrentStartSchoolYearRunResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.run !== undefined) {
            exports.StartSchoolYearRun.encode(message.run, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.run = exports.StartSchoolYearRun.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return { run: isSet(object.run) ? exports.StartSchoolYearRun.fromJSON(object.run) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.run !== undefined) {
            obj.run = exports.StartSchoolYearRun.toJSON(message.run);
        }
        return obj;
    },
    create(base) {
        return exports.GetCurrentStartSchoolYearRunResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetCurrentStartSchoolYearRunResponse();
        message.run = (object.run !== undefined && object.run !== null)
            ? exports.StartSchoolYearRun.fromPartial(object.run)
            : undefined;
        return message;
    },
};
function createBaseStartCurrentStartSchoolYearPhaseRequest() {
    return { context: undefined, organization_id: undefined, phase: undefined };
}
exports.StartCurrentStartSchoolYearPhaseRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.context !== undefined) {
            request_context_1.RequestContext.encode(message.context, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.StartCurrentStartSchoolYearPhaseRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStartCurrentStartSchoolYearPhaseRequest();
        message.context = (object.context !== undefined && object.context !== null)
