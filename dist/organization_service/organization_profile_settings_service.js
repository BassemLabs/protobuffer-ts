...
function createBaseUpdateGraduationSettingsRequest() {
    return {
        context: undefined,
...
exports.UpdateGraduationSettingsRequest = {
    ...
    create(base) {
        return exports.UpdateGraduationSettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseUpdateGraduationSettingsRequest();
        message.context = (object.context !== undefined && object.context !== null)
...
function createBaseGetDataExportSecuritySettingsRequest() {
    return { context: undefined };
}
exports.GetDataExportSecuritySettingsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.context !== undefined) {
            request_context_1.RequestContext.encode(message.context, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.GetDataExportSecuritySettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetDataExportSecuritySettingsRequest();
        message.context = (object.context !== undefined && object.context !== null)
...
function createBaseInitializeDataExportSecuritySettingsRequest() {
    return { context: undefined, allowed_networks: [], current_source_ip: undefined };
}
exports.InitializeDataExportSecuritySettingsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.context !== undefined) {
            request_context_1.RequestContext.encode(message.context, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.InitializeDataExportSecuritySettingsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseInitializeDataExportSecuritySettingsRequest();
        message.context = (object.context !== undefined && object.context !== null)
