...
exports.Semester = {
    ...
    fromJSON(object) {
        return {
            ...
            report_layout: isSet(object.report_layout) ? exports.SemesterReportLayout.fromJSON(object.report_layout) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.report_layout !== undefined) {
            obj.report_layout = exports.SemesterReportLayout.toJSON(message.report_layout);
        }
        if (message.campus_id !== undefined) {
...
exports.SemesterReportLayout = {
    ...
    fromJSON(object) {
        return {
            ...
            learning_skills: globalThis.Array.isArray(object?.learning_skills)
                ? object.learning_skills.map((e) => exports.SemesterLearningSkill.fromJSON(e))
                : [],
            report_dates: globalThis.Array.isArray(object?.report_dates)
                ? object.report_dates.map((e) => exports.ReportDates.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if (message.learning_skills?.length) {
            obj.learning_skills = message.learning_skills.map((e) => exports.SemesterLearningSkill.toJSON(e));
        }
        if (message.report_dates?.length) {
            obj.report_dates = message.report_dates.map((e) => exports.ReportDates.toJSON(e));
        }
        if (message.hide_learning_skills_from_homerooms !== false) {
