...
exports.OrganizationPaymentPlan = {
    ...
    fromJSON(object) {
        return {
            ...
            upfront_cost_payment_interval: isSet(object.upfront_cost_payment_interval)
                ? paymentIntervalFromJSON(object.upfront_cost_payment_interval)
    ...
    toJSON(message) {
        ...
        if (message.upfront_cost_payment_interval !== PaymentInterval.Monthly) {
            obj.upfront_cost_payment_interval = paymentIntervalToJSON(message.upfront_cost_payment_interval);
        }
        if (message.per_student_cost !== 0) {
...
exports.OrganizationPaymentPlanInformation = {
    ...
    fromJSON(object) {
        return {
            id: isSet(object.id) ? object_id_1.ObjectId.fromJSON(object.id) : undefined,
            organization_id: isSet(object.organization_id) ? object_id_1.ObjectId.fromJSON(object.organization_id) : undefined,
            payment_plan: isSet(object.payment_plan) ? object_id_1.ObjectId.fromJSON(object.payment_plan) : undefined,
            ...
            trial_days: isSet(object.trial_days) ? globalThis.Number(object.trial_days) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.payment_plan !== undefined) {
            obj.payment_plan = object_id_1.ObjectId.toJSON(message.payment_plan);
        }
        if (message.defer_per_student_cost_to_parent !== false) {
        ...
        if (message.trial_days !== 0) {
            obj.trial_days = Math.round(message.trial_days);
        }
        return obj;
    },
    create(base) {
...
exports.OrganizationPaymentPlanWithInfo = {
    ...
    fromJSON(object) {
        return {
            payment_plan: isSet(object.payment_plan) ? exports.OrganizationPaymentPlan.fromJSON(object.payment_plan) : undefined,
            payment_plan_info: isSet(object.payment_plan_info)
                ? exports.OrganizationPaymentPlanInformation.fromJSON(object.payment_plan_info)
                : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.payment_plan !== undefined) {
            obj.payment_plan = exports.OrganizationPaymentPlan.toJSON(message.payment_plan);
        }
        if (message.payment_plan_info !== undefined) {
            obj.payment_plan_info = exports.OrganizationPaymentPlanInformation.toJSON(message.payment_plan_info);
        }
        return obj;
    },
    create(base) {
